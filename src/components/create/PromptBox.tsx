      ...
      <div className="bg-white rounded-2xl shadow-lg prompt-box">
        <div className="relative pb-14">
          ...
          <Textarea 
            ...
            } placeholder:text-gray-500 placeholder:font-[400] scrollbar-thin scrollbar-thumb-gray-200 hover:scrollbar-thumb-gray-300 scrollbar-track-transparent pr-12`}
          />
          <input
            type="file"
            ref={fileInputRef}
