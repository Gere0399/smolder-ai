            ...
            <div className="bg-white rounded-2xl shadow-lg prompt-box">
              <div className="relative pb-14">
                ...
                <Textarea 
                  ...
                  className={`min-h-[96px] max-h-[200px] w-full resize-y overflow-y-auto border-0 bg-transparent px-6 py-4 focus-visible:ring-0 focus-visible:ring-offset-0 text-[16px] text-black rounded-2xl ${prompt ? 'placeholder:text-gray-900' : 'placeholder:text-gray-400'} placeholder:font-[500] scrollbar-thin scrollbar-thumb-gray-200 hover:scrollbar-thumb-gray-300 scrollbar-track-transparent pr-8`}
                />
                <input
                  type="file"
                  ref={fileInputRef}
